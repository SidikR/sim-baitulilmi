                        ...
                        <tbody>
                            ...
                            <?php foreach ($daftar_pemasukan as $dp) : ?>
                                <tr>
                                    ...
                                    <td><?= $dp->keterangan ?></td>
                                    <td><?= 'Rp. ' . number_format($dp->masuk); ?></td>
                                    <td style="width: 15%;">
                                        <a href="<?= 'pemasukan/detail/' . $dp->id_keuangan; ?>"><button type="button" class="btn btn-success btn-sm"><i class="fas fa-file-alt"></i> Lihat</button></a>
                                        <a href="<?= 'pemasukan/edit/' . $dp->id_keuangan; ?>"><button type="button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</button></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-trash-alt "></i> Hapus Data Pemasukan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="pemasukan/hapus/<?= $dp->id_keuangan; ?>" method="post">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="_method" value="DELETE">
                        <p>Yakin data pemasukan <b><?= $dp->keterangan; ?></b> akan dihapus ?</p>
                </div>
