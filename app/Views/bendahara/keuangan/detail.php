                                    ...
                                    <form>
                                        <fieldset disabled>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="disabledTextInput" class="form-control" placeholder='<?= 'Rp. ' . number_format($pengeluaran->nominal_pengeluaran); ?>'>
                                            </div>
                                            <div class="mb-3">
                                                <label for="disabledTextInput" class="form-label">Keterangan</label>
                                                <input type="text" id="disabledTextInput" class="form-control" placeholder='<?= $pengeluaran->keterangan_pengeluaran; ?>'>
                                            </div>
                                        </fieldset>
                                    </form>
                                    <a href="<?php echo base_url('pengeluaran'); ?>"><button type="button" class="btn btn-danger">Kembali</button></a>
                                    <a href="<?= '.././edit/' . $pengeluaran->slug_pengeluaran; ?>"><button type="submit" class="btn btn-primary">Edit</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
