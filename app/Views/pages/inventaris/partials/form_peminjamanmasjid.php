                ...
                <div class="row d-flex">
                    <div class="col-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('nama_penanggungjawab') ? 'is-invalid' : null; ?>" id="nama_penanggungjawab_masjid" placeholder="Isikan Nama Penanggung Jawab" name="nama_penanggungjawab" rows="3">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" class="form-control" id="formFileKTP" name="foto_identitas" required>
                        </div>
