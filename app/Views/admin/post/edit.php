                    ...
                    <div class="card mb-3 " style="max-width: 100%;">
                        <div class="row m-3">
                            ...
                            <div class="col-md-12 col-lg-8">
                                <div class="card-body">
                                    <form action="./<?= $daftar_post->id_post; ?>" method="post" enctype="multipart/form-data">
                                        <?= csrf_field(); ?>
                                        <input type="hidden" name="_method" value="PUT">
                                        <fieldset>
                                            <legend>Edit Data Post Judul : <b><?= $daftar_post->nama_post; ?></b></legend>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label for="disabledTextInput" class="form-label">Judul Post</label>
                                                        <input type="text" class="form-control" value='<?= $daftar_post->nama_post; ?>' name="nama_post">
                                                    </div>
                                                    <div class="mb-3">
            ...
            <div class="modal-body">
                <form action="./foto/<?= $daftar_post->id_post; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <p class="image_upload">
                        ...
                        <input type="file" id="userImage" name="foto_post" onchange="readURL(this);" />
                    </p>
