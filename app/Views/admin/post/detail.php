                                    ...
                                    <div class="inventaris container-fluid mt-auto mb-auto" style="width : 100% ; height : 100% ;  ">
                                        <div class="inventaris-item">
                                            ...
                                            <div class="inventaris-info">
                                                ...
                                                <a href="<?php echo base_url('assets-admin/img/post/' . $post->foto_post); ?>" title="<?= $post->nama_post; ?>" data-gallery="inventaris-gallery" class="glightbox preview-link pe-3"><i class="bi bi-zoom-in"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
