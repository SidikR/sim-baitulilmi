    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    <a href="inventaris/tambah"><button type="button" class="btn btn-tambah mb-3" data-bs-toggle="modal">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($daftar_inventaris as $di) : ?>
                                <tr>
                                    ...
                                    <td style="width: 15%;">
                                        <a href="<?= 'inventaris/detail/' . $di->slug_inventaris; ?>"><button type="button" class="btn btn-read btn-sm"><i class="bi bi-book-fill"></i></button></a>
                                        <a href="<?= 'inventaris/edit/' . $di->slug_inventaris; ?>"><button type="button" class="btn btn-edit btn-sm"><i class="bi bi-pencil-square"></i></button></a>
                                        <button type="button" class="btn btn-delete btn-sm" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $di->id_inventaris; ?>"><i class="bi bi-trash3-fill"></i></button>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
