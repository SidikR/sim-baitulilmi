                                ...
                                <div class="col-md-12 mt-auto mb-auto ">
                                    <div class="portfolio container-fluid mt-auto mb-auto" style="width : 100% ; height : 100% ;  ">
                                        <div class="portfolio-item">
                                            <img style="max-width : 400px ; max-height : 400px ;  " src="<?php echo base_url('assets-admin/img/petugas-jumat/' . $daftar_petugasjumat->poster); ?>" class="img-fluid rounded float-center ms-auto me-auto d-block mb-3" alt="">
                                            <div class="portfolio-info">
                                                <h4><?= $daftar_petugasjumat->nama_imam; ?></h4>
                                                <a href="<?php echo base_url('assets-admin/img/petugas-jumat/' . $daftar_petugasjumat->poster); ?>" title="<?= $daftar_petugasjumat->nama_imam; ?>" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
