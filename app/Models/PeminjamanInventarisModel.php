...
class PeminjamanInventarisModel extends Model
{
    ...
    protected $allowedFields    = ['id_user', 'status_infaq', 'id_barang', 'qty', 'instansi_peminjam', 'nama_penanggungjawab', 'tanggal_dipinjam', 'tanggal_pengembalian', 'infaq', 'metode_infaq', 'foto_identitas', 'bukti_transfer', 'status_peminjaman', 'pesan'];
